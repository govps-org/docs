---
canonicalUrl: 'https://docs.govps.org/1.0/sites/commands.html'
---
# Commands
...
The last 10 previously executed commands will be shown within the **Command History** table. Alongside the command that was run, GoVPS will also display:

- The user who initiated the command. This is particularly helpful when using GoVPS within [Circles](/1.0/accounts/circles.html).
